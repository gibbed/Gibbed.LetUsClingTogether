...
namespace Gibbed.TacticsOgre.FileFormats.Screenplay
{
    public static class TaskOpcodeHelpers
    {
        public static bool IsValid(this TaskOpcode opcode) => opcode switch
        {
            ...
            TaskOpcode.SetSystemSaveFlag => true, // Reborn
            TaskOpcode.SetGlobalFlagIfLower => true, // Reborn
            ...
            TaskOpcode.CompareAlliesSlainCount => true,
            TaskOpcode.CompareAlliesIncapacitatedCount => true,
            ...
            TaskOpcode.CompareSystemSaveFlag => true, // Reborn
            TaskOpcode.CompareSystemPlatform => true, // Reborn
        ...
        public static TaskType GetTaskType(this TaskOpcode opcode) => opcode switch
        {
            ...
            TaskOpcode.SetSystemSaveFlag => TaskType.ProcessingTask,
            TaskOpcode.SetGlobalFlagIfLower => TaskType.ProcessingTask,
            ...
            TaskOpcode.CompareAlliesSlainCount => TaskType.Invocation,
            TaskOpcode.CompareAlliesIncapacitatedCount => TaskType.Invocation,
            ...
            TaskOpcode.CompareSystemSaveFlag => TaskType.Invocation,
            TaskOpcode.CompareSystemPlatform => TaskType.Invocation,
        ...
        public static int GetSize(this TaskOpcode opcode) => opcode switch
        {
            ...
            TaskOpcode.SetSystemSaveFlag => 3, // Reborn
            TaskOpcode.SetGlobalFlagIfLower => 3, // Reborn
            ...
            TaskOpcode.CompareAlliesSlainCount => 3,
            TaskOpcode.CompareAlliesIncapacitatedCount => 3,
            TaskOpcode.CompareOverallChariotAndRetreatingNotUsed => 2,
            TaskOpcode.CompareHasCharacter => 3,
            TaskOpcode.Unknown54 => 2, // Reborn
            TaskOpcode.CompareSystemSaveFlag => 4, // Reborn
            TaskOpcode.CompareSystemPlatform => 2, // Reborn
        ...
        public static TaskOpcodeArguments GetArguments(this TaskOpcode opcode) => opcode switch
        {
            ...
            TaskOpcode.CompareAlliesSlainCount => (TargetType.None, ValueType.UInt16),
            TaskOpcode.CompareAlliesIncapacitatedCount => (TargetType.None, ValueType.UInt16),
        ...
        public static int GetCallbackAddressPSP(this TaskOpcode opcode) => opcode switch
        {
            ...
            TaskOpcode.SetSystemSaveFlag => 0x088B6C08,
            TaskOpcode.SetGlobalFlagIfLower => 0x088B6C08,
            ...
            TaskOpcode.CompareAlliesSlainCount => 0x088B8E68,
            TaskOpcode.CompareAlliesIncapacitatedCount => 0x088B8EF8,
            ...
            TaskOpcode.CompareSystemSaveFlag => 0x088B6C08,
            TaskOpcode.CompareSystemPlatform => 0x088B6C08,
